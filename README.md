...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/tx_dmv_vehicle_registrations \
  -H 'Content-Type: application/json' \
  -d '{"fiscal_year":"2021"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/tx_dmv_vehicle_registrations`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
